...
class Scenario1Task1 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.scenario1_task1)

        val text1 = getString(R.string.scenario_1_task_1_message_3)
        val textToModify1 = listOf("Your task:","pharmacy")
        val text1Modified = Utils().modifyNumberStyle(text1,textToModify1,this)
        val text1View = findViewById<TextView>(R.id.scenario_1_task_1_message_3)
        text1View.text = text1Modified

        val text2 = getString(R.string.scenario_1_task_1_message_5)
        val textToModify2 = listOf("Keep on walking")
        val text2Modified = Utils().modifyNumberStyle(text2,textToModify2,this)
        val text2View = findViewById<TextView>(R.id.scenario_1_task_1_message_5)
        ...
        val text4 = getString(R.string.scenario_1_task_1_message_6)
        val textToModify4 = listOf("warning message")
        val text4Modified = Utils().modifyNumberStyle(text4,textToModify4,this)
        val text4View = findViewById<TextView>(R.id.scenario_1_task_1_message_6)
    ...
    fun onClickScenario1Task1ButtonListener(View: android.view.View){

        val properties =
            Utils.Properties(Constants.URL_NON_ADAPTIVE, Constants.POI_SCENARIO_I_NON_ADAPTIVE,1,1,false)
