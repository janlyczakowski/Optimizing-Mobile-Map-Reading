...
class Scenario2Task2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.scenario2_task2)

        val text1 = getString(R.string.scenario_2_task_2_message_3)
        val textToModify1 = listOf("Your task:","bus stop")
        val text1Modified = Utils().modifyNumberStyle(text1,textToModify1,this)
        val text1View = findViewById<TextView>(R.id.scenario_2_task_2_message_3)
        text1View.text = text1Modified

        val text2 = getString(R.string.scenario_2_task_2_message_5)
        val textToModify2 = listOf("run")
        val text2Modified = Utils().modifyNumberStyle(text2,textToModify2,this)
        val text2View = findViewById<TextView>(R.id.scenario_2_task_2_message_5)
        text2View.text = text2Modified

        val text3 = getString(R.string.scenario_2_task_2_message_6)
        val textToModify3 = listOf("warning message")
        val text3Modified = Utils().modifyNumberStyle(text3,textToModify3,this)
        val text3View = findViewById<TextView>(R.id.scenario_2_task_2_message_6)
    ...
    fun onClickScenario2Task2ButtonListener(View: android.view.View){

        val properties =
            Utils.Properties(Constants.URL_NON_ADAPTIVE, Constants.POI_SCENARIO_II_NON_ADAPTIVE,2,2,false)
