...
class Scenario3Task1 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.scenario3_task1)

        val text1 = getString(R.string.scenario_3_task_1_message_3)
        val textToModify1 = listOf("Your task:","toilet")
        val text1Modified = Utils().modifyNumberStyle(text1,textToModify1,this)
        val text1View = findViewById<TextView>(R.id.scenario_3_task_1_message_3)
        text1View.text = text1Modified

        val text2 = getString(R.string.scenario_3_task_1_message_5)
        val textToModify2 = listOf("Keep on walking")
        val text2Modified = Utils().modifyNumberStyle(text2,textToModify2,this)
        val text2View = findViewById<TextView>(R.id.scenario_3_task_1_message_5)
        text2View.text = text2Modified

        val text3 = getString(R.string.scenario_3_task_1_message_6)
        val textToModify3 = listOf("warning message")
        val text3Modified = Utils().modifyNumberStyle(text3,textToModify3,this)
        val text3View = findViewById<TextView>(R.id.scenario_3_task_1_message_6)
    ...
    fun onClickScenario3Task1ButtonListener(View: android.view.View){

        val properties =
            Utils.Properties(Constants.URL_NON_ADAPTIVE, Constants.POI_SCENARIO_III_NON_ADAPTIVE,3,1,false)
